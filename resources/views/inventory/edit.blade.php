    ...
    <div class="card" id="edit-inventory-form">
            ...
            @if($inventoryItem->disposition && $inventoryItem->disposition_date && !$inventoryItem->trashed())
                ...
                <div class="row">
                    <div class="col s12">
                        ...
                        <span style="padding-left: 1em;"><strong>Warning:</strong> Once destroyed, the inventory item can no longer be updated</span></p>
                    </div>
                    <div class="col s12">
        ...
        @elseif($inventoryItem->trashed())
                ...
                <p style="display: inline-flex;
                    ...
                    <span style="padding-left: 1em;"><strong style="font:larger;">Destroyed</strong></span></p>
                </div>
        @endif
